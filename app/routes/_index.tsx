...
export const meta: MetaFunction = () => {
  return [
    ...
    { name: "description", content: "Your AI-powered early education assistant" },
  ];
};
  ...
  return (
    <RootLayout>
      <div className="flex flex-col items-center justify-center min-h-screen max-w-4xl mx-auto p-4 pl-24 text-center">
        <h1 className="text-4xl font-bold mb-4">Welcome to Early Education Assistant</h1>
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
          Your AI-powered assistant for early education. Get help with lesson planning,
