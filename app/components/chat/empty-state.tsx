  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 text-center">
      ...
      <p className="max-w-lg text-sm text-muted-foreground sm:text-base">
        ...
        learning frameworks, teaching strategies, or professional development - I'm here to help you
        grow as an educator. Just type your question below to get started!
      </p>
    </div>
  );
}
